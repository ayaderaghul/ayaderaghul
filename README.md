...
-- JS/TS (react, nodejs) projects: [Housy](https://hms-fe-l3j1.onrender.com/) a house management app managing cleaning tasks and assigned people, [Sereno](https://sereno-fe.onrender.com/) a journaling app that utilises AI for recommendation of resources/event locally for your daily entries,[uberEatsClone](https://github.com/ayaderaghul/uberEatsClone-160826) with Redis caching, Kafka for logging and RabbitMQ for event driven architecture; [twitter clone]([https://github.com/ayaderaghul/twitter](https://github.com/ayaderaghul/twitter-core-230826)) with a take at distributed system: push/pull hybrid model of timeline and transactional outbox pattern; [load balancer](https://github.com/ayaderaghul/load-balancer) with least response time algorithm and round robin; [rate limiter](https://github.com/ayaderaghul/rate-limiter) with token bucket and fixed window counter algo
