...
-- JS/TS (react, nodejs) projects: [Housy](https://hms-fe-l3j1.onrender.com/) a house management app managing cleaning tasks and assigned people, [Sereno](https://sereno-fe.onrender.com/) a journaling app that utilises AI for recommendation of resources/event locally for your daily entries,[uberEatsClone](https://github.com/ayaderaghul/uber-eats-clone/tree/master) with Redis caching, Kafka and RabbitMQ; [twitter clone](https://github.com/ayaderaghul/twitter3) with a take at event driven architecture. CRRUD and Kafka workers to create notification in db and precompute timeline cache in Redis; [load balancer](https://github.com/ayaderaghul/load-balancer) with least response time algorithm and round robin; [rate limiter](https://github.com/ayaderaghul/rate-limiter) with token bucket and fixed window counter algo
